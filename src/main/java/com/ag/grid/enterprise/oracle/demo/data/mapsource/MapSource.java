...
public interface MapSource<K> {
     ...
     * filters for consecutive calls to {@link FilteredMapSource#getKeys()} and {@lik com.ag.grid.enterprise.oracle.demo.data.mapsource.FilteredMapSource#getAll(java.util.Collection)}.
     *
