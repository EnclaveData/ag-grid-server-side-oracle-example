...
/**
 * Map source with configured filter. Instance of this class should be obtained by a call to {@link MapSource#filter(com.ag.grid.enterprise.oracle.demo.data.RequestFilters)}.
 *
